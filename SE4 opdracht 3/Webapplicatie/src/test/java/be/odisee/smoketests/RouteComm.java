...
public class RouteComm extends SeleneseTestCase {
	...
	@Test
	public void test3RouteCommJUnit() throws Exception {
		selenium.open("/brainstorm2015WA3/login.html");
		selenium.type("id=username", "comm@mail.com");
		...
		selenium.waitForPageToLoad("30000");
		verifyEquals("Welkom Community Manager", selenium.getText("css=h1"));
