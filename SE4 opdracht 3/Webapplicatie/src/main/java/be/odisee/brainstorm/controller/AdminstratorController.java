...
public class AdminstratorController {
    ...
    public String persoonToevoegen(@ModelAttribute("depersoon") @Valid Gebruiker persoon,
                                                        BindingResult result, ModelMap model){

        if (result.hasErrors()) return "/admin/nieuwePersoon";  // fouten op de form => form opnieuw tonen

        Gebruiker toegevoegdPersoon = brainstormSessieService.voegPersoonToe(persoon.getVoornaam(),
    ...
    public String rechtenToevoegen(@ModelAttribute("rights") @Valid Rol rol,
                                                        BindingResult result, ModelMap model) throws RolNotFoundException{
